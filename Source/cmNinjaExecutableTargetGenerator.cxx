...
//----------------------------------------------------------------------------
void cmNinjaExecutableTargetGenerator::WriteRuleFiles()
{
...
//----------------------------------------------------------------------------
void cmNinjaExecutableTargetGenerator::WriteExecutableRule(bool relink)
{
...
//----------------------------------------------------------------------------
void
cmNinjaExecutableTargetGenerator::CreateAppBundle(std::string& targetName,
                                                     std::string& outpath)
{
