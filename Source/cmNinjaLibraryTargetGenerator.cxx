...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteRuleFiles()
{
...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteStaticLibraryRules()
{
...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteSharedLibraryRules(bool relink)
{
  if(this->Target->IsFrameworkOnApple())
    {
...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteModuleLibraryRules(bool relink)
{
  const char* linkLanguage =
    this->Target->GetLinkerLanguage(this->ConfigName);
  std::string linkRuleVar = "CMAKE_";
...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteFrameworkRules(bool relink)
{
  const char* linkLanguage =
    this->Target->GetLinkerLanguage(this->ConfigName);
  std::string linkRuleVar = "CMAKE_";
...
//----------------------------------------------------------------------------
void cmNinjaLibraryTargetGenerator::WriteLibraryRules
(const char* linkRuleVar, const char* extraFlags, bool relink)
{
  ...
  if(!this->NoRuleMessages)
    ...
    this->LocalGenerator->AppendEcho(commands, buildEcho.c_str(),
                                     cmLocalNinjaGenerator::EchoLink);
    }
