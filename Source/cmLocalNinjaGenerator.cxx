...
void cmLocalNinjaGenerator::Generate()
{
  ...
  cmGlobalNinjaGenerator* gg =
    static_cast<cmGlobalNinjaGenerator*>(this->GlobalGenerator);
  for(cmTargets::iterator t = targets.begin(); t != targets.end(); ++t)
    {
    cmsys::auto_ptr<cmNinjaTargetGenerator> tg(
      cmNinjaTargetGenerator::New(&(t->second)));
    if (tg.get())
      {
      tg->WriteRuleFiles();
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::GetIndividualFileTargets
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::WriteLocalMakefile()
{
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::WriteDirectoryInformationFile()
{
...
const std::string &cmLocalNinjaGenerator::GetHomeRelativeOutputPath()
{
...
//----------------------------------------------------------------------------
std::string
cmLocalNinjaGenerator::MakeLauncher(const cmCustomCommand& cc,
                                            cmTarget* target,
...
//----------------------------------------------------------------------------
void
cmLocalNinjaGenerator::AppendEcho(std::vector<std::string>& commands,
                                          const char* text,
                                          EchoColor color)
{
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::CheckMultipleOutputs(bool verbose)
{
  cmMakefile* mf = this->Makefile;
  ...
  for ( glIt = targets->begin(); glIt != targets->end(); ++ glIt )
    ...
    if ( glIt->second.GetType() == cmTarget::GLOBAL_TARGET )
      ...
      this->AppendEcho(commands, text,
                       cmLocalNinjaGenerator::EchoGlobal);
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::WriteDisclaimer(std::ostream& os)
{
  os
...
//----------------------------------------------------------------------------
void cmLocalNinjaGenerator::WriteDivider(std::ostream& os)
{
  os
    << "#======================================"
    << "=======================================\n";
...
//----------------------------------------------------------------------------
std::string
cmLocalNinjaGenerator::ConvertToQuotedOutputPath(const char* p)
{
...
//----------------------------------------------------------------------------
cmLocalNinjaGenerator::ImplicitDependLanguageMap const&
cmLocalNinjaGenerator::GetImplicitDepends(cmTarget const& tgt)
{
...
//----------------------------------------------------------------------------
void
cmLocalNinjaGenerator::AddImplicitDepends(cmTarget const& tgt,
                                                  const char* lang,
                                                  const char* obj,
                                                  const char* src)
{
