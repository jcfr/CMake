...
cmNinjaTargetGenerator::New(cmTarget *tgt)
{
  cmNinjaTargetGenerator *result = 0;

  switch (tgt->GetType())
    {
    case cmTarget::EXECUTABLE:
      result = new cmNinjaExecutableTargetGenerator(tgt);
      break;
    case cmTarget::STATIC_LIBRARY:
    case cmTarget::SHARED_LIBRARY:
    case cmTarget::MODULE_LIBRARY:
      result = new cmNinjaLibraryTargetGenerator(tgt);
      break;
    case cmTarget::UTILITY:
      result = new cmNinjaUtilityTargetGenerator(tgt);
      break;
    default:
      return result;
      // break; /* unreachable */
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::CreateRuleFile()
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetBuildRules()
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteCommonCodeRules()
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetLanguageFlags()
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteMacOSXContentRules(cmSourceFile& source,
                                                        const char* pkgloc)
{
  ...
  this->LocalGenerator->AppendEcho(commands, copyEcho.c_str(),
                                   cmLocalNinjaGenerator::EchoBuild);
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteObjectRuleFiles(cmSourceFile& source)
{
  ...
  cmLocalNinjaGenerator::LocalObjectInfo& info =
    this->LocalGenerator->LocalObjectFiles[objNoTargetDir];
  info.HasSourceExtension = hasSourceExtension;
  info.push_back(
    cmLocalNinjaGenerator::LocalObjectEntry(this->Target, lang)
    );
}
                       ...
                       std::vector<std::string>& depends)
{
  ...
  if(!this->NoRuleMessages)
    ...
    this->LocalGenerator->AppendEcho
      (commands, buildEcho.c_str(), cmLocalNinjaGenerator::EchoBuild);
    }
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetRequiresRules()
{
  std::vector<std::string> depends;
  std::vector<std::string> no_commands;
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetCleanRules()
{
  std::vector<std::string> depends;
  std::vector<std::string> commands;
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetDependRules()
{
    ...
    if(!this->NoRuleMessages)
      ...
      this->LocalGenerator
        ->AppendEcho(commands, comment.c_str(),
                     cmLocalNinjaGenerator::EchoGenerate);
      }
    }
...
//----------------------------------------------------------------------------
void
cmNinjaTargetGenerator::AppendProgress(std::vector<std::string>& commands)
{
...
//----------------------------------------------------------------------------
class cmNinjaTargetGeneratorObjectStrings
{
public:
  cmNinjaTargetGeneratorObjectStrings(std::vector<std::string>& strings,
                                         cmMakefile* mf,
...
::WriteObjectsStrings(std::vector<std::string>& objStrings,
                      std::string::size_type limit)
{
  cmNinjaTargetGeneratorObjectStrings
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::WriteTargetDriverRule(const char* main_output,
                                                      bool relink)
{
...
//----------------------------------------------------------------------------
std::string cmNinjaTargetGenerator::GetFrameworkFlags()
{
...
void cmNinjaTargetGenerator::RemoveForbiddenFlags(const char* flagVar,
                                                     const char* linkLang,
...
//----------------------------------------------------------------------------
const char* cmNinjaTargetGenerator::GetFortranModuleDirectory()
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::AddFortranFlags(std::string& flags)
{
...
//----------------------------------------------------------------------------
void cmNinjaTargetGenerator::AddFeatureFlags(
