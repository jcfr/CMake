...
bool cmCTest::InitializeFromCommand(cmCTestStartCommand* command)
{
  ...
  if ( cmSystemTools::FileExists(bld_dir_fname.c_str()) )
    ...
    {
    if ( cmSystemTools::FileExists(src_dir_fname.c_str()) )
      {
      fname = src_dir_fname;
      }
    }
  ...
  if ( !fname.empty() )
    ...
    {
    cmCTestLog(this, WARNING, "Cannot locate CTest configuration in SourceDirectory: "
      << src_dir_fname.c_str() << std::endl);
    cmCTestLog(this, WARNING, "Cannot locate CTest configuration in BuildDirectory: "
