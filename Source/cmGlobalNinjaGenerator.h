 ...
 *
 * cmGlobalNinjaGenerator manages UNIX build process for a tree
...
public:
  ...
  void RecordTargetProgress(cmNinjaTargetGenerator* tg);
...
protected:
  ...
  size_t CountProgressMarksInAll(cmLocalNinjaGenerator* lg);
};
